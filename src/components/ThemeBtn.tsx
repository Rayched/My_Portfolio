...
const Circle = styled(motion.div)`
    ...
    border-radius: 25px;
    margin: 1px 0px;
    background-color: rgb(170, 166, 157);
    z-index: 1;
`;

const ThemeIcons = styled.svg`
    display: block;
    position: absolute;
`;
...
export default function ThemeBtn(){
    ...
    return (
        <BtnContainer onClick={setDark}>
            <ThemeBox>
                <ThemeIcons xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 640 640">
                ...
                {isDark ? <Circle layoutId="circle"/> : null}
            </ThemeBox>
            <ThemeBox>
                <ThemeIcons xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 640 640" fill="black">
                ...
                {isDark ? null : <Circle layoutId="circle"/>}
            </ThemeBox>
        </BtnContainer>
    );
};